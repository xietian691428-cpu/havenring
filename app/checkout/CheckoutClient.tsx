    ...
    <div className="space-y-10">
      <div>
        ...
        <p className="mt-3 text-sm text-[#AAAAAA]">
          One ring for you, or two by invite — one account per person. We ship manually after
          payment; you will receive a confirmation email with your order reference.
        </p>
      </div>
