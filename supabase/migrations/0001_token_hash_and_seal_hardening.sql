...
-- ---------------------------------------------------------------------------
-- RPC: canonical seal path by pending moment id + plaintext token
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Legacy compatibility overload: seal by ring_id, picks earliest pending row.
-- This keeps existing clients working while newer clients pass p_moment_id.
-- ---------------------------------------------------------------------------
...
begin
  ...
  return public.seal_moment(v_target_moment_id, p_token);
end;
$function$;
