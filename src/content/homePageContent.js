const EN = {
  ...
  ringSecurityRecoveryHint:
    "Save this code somewhere safe. You can use it to authorize a new device if you forget your password.",
  ringSecurityPasswordTooShort: "Password must be at least 6 characters.",
