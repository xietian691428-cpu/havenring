const EN = {
  ...
  feedbackNeedContent: "请先写内容",
  feedbackSavingLocal: "保存中",
  feedbackSavingTimeline: "保存中",
  feedbackSaved: "已保存",
  feedbackSavedTimeline: "Saved to your timeline. You can open it from Home.",
  feedbackReadyToSeal: "请贴上戒指",
  feedbackMissingVerifiedTap: "请贴上戒指",
  feedbackDraftRestored: "已恢复",
  feedbackSaveFailed: "保存失败",
  feedbackReadyNext: "继续写",
  feedbackSealPrepNeedDraftSave: "请先保存",
