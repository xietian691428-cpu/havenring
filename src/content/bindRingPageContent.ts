export const BIND_RING_PAGE_EN = {
  ...
  statusRetired: "This ring cannot be used with this account.",
  ...
  inviteKeyMissing: "This link is no longer valid — ask for a new one.",
  ...
  forgotPasswordLink: "Forgot device password?",
  ...
  joinErrorGeneric: "Could not join — try again.",
} as const;
