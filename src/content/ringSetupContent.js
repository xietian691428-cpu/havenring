const EN = {
  ...
  scanTitle: "Link your ring in 2 steps",
  scanBody:
    "Step 1: tap Start scanning. Step 2: hold your ring to the back of your phone.",
  scanCta: "Start scanning (then tap ring)",
  scanWorking: "Listening for NFC… now tap your ring.",
  scanOrderTitle: "Order",
  scanOrderStep1: "1) Tap the button below.",
  scanOrderStep2: "2) Then touch your ring to the phone.",
  scanRetry: "Try again",
  ...
  setupPasswordLabel: "Set device password",
  setupPasswordPlaceholder: "At least 6 characters",
  setupPasswordConfirmLabel: "Confirm password",
  setupPasswordConfirmPlaceholder: "Type again",
  setupSecurityCta: "Set password & continue",
  setupSecurityWorking: "Setting up...",
  setupSecurityDone: "Device protection is ready. Continuing binding...",
  setupSecurityFailed: "Could not set device protection. Please try again.",
  setupPasswordTooShort: "Password must be at least 6 characters.",
  setupPasswordMismatch: "Passwords do not match.",
  setupRecoveryHint: "Recovery code",
