...
const EN = {
  brand: "Haven",
  title: "My Rings",
  subtitle: "One private Haven. One ring per partner.",
  layeredCoreLine: HAVEN_EN_LAYERED_CORE_LINE,
  emptyTitle: "No rings yet",
  emptyBody:
    "Bind your ring first. Invite your partner later.",
  emptyTrialHint:
  ...
  addAnotherRingSecondary: "Add Partner Ring",
  invitePartnerCta: "Add Partner Ring",
  inviteCreating: "Preparing your invite...",
  inviteReady: "Invite copied. Valid for 24 hours:",
  revokeInvite: "Revoke invite",
  invitePanelKicker: "Partner ring",
  invitePanelTitle: "Add your partner's ring",
  invitePanelSubtitle: "Send this to your partner's phone — not yours.",
  inviteBackCta: "← My Rings",
  inviteChecklist: [
    "Send this link to your partner's phone",
    "They open it on their own device",
    "They tap their own ring to join",
  ],
  inviteSelfWarning: "Don't open this link yourself. Your partner needs their own account and ring.",
  inviteShareCta: "Share Invite Link",
  inviteCopyLinkCta: "Copy Link",
  inviteSharing: "Opening share…",
  inviteLinkCopied: "Link copied.",
  inviteWaitingTitle: "Invite sent! Waiting for your partner to join…",
  inviteWaitingBody: "We'll refresh when their ring connects. Valid for 24 hours.",
  invitePartnerJoinedTitle: "Your partner joined!",
  invitePartnerJoinedBody: "Both rings are now linked to your shared Haven.",
  ...
  privacyNote:
    "Each partner uses their own account and ring.",
  iosUsageHint:
