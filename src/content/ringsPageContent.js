...
const EN = {
  brand: "Haven",
  title: "My Rings",
  subtitle: "Optional ring for sealing. One account per person.",
  layeredCoreLine: HAVEN_EN_LAYERED_CORE_LINE,
  emptyTitle: "No rings yet",
  emptyBody: "Link a ring when you want to seal with a touch.",
  emptyTrialHint:
  ...
  addAnotherRingSecondary: "Bind another ring",
  invitePartnerCta: "Invite partner",
  legacySecondRingTitle: "Form a Pair",
  legacySecondRingBody:
    "Invite your partner (one account each). Sealed memories sync in your Pair. Drafts stay private until sealed.",
  legacySecondRingCta: "Invite partner",
  legacyInviteBanner:
    "Pair mode: two people, two rings, shared sealed memories. Plus keeps them in sync across devices.",
  pairActiveBanner: "Pair active — sealed memories are shared between you.",
  pairShareToggleLabel: "Share sealed memories with my partner",
  inviteCreating: "Preparing your invite...",
  inviteReady: "Invite copied. Valid for 24 hours:",
  revokeInvite: "Revoke invite",
  invitePanelKicker: "Legacy invite",
  invitePanelTitle: "Second ring — separate account",
  invitePanelSubtitle: "Send to their phone. They sign in with their own account.",
  inviteBackCta: "← My Rings",
  inviteChecklist: [
    "Send this link to their phone",
    "They open it on their own device",
    "They sign in and tap their own ring",
  ],
  inviteSelfWarning: "Don't open this yourself. They need their own account and ring.",
  inviteShareCta: "Share Invite Link",
  inviteCopyLinkCta: "Copy Link",
  inviteSharing: "Opening share…",
  inviteLinkCopied: "Link copied.",
  inviteWaitingTitle: "Invite sent. Waiting for the second ring…",
  inviteWaitingBody: "We'll refresh when their ring connects. Valid for 24 hours.",
  invitePartnerJoinedTitle: "Second ring linked",
  invitePartnerJoinedBody: "Pair complete. Sealed memories now appear for both of you.",
  inviteDoneCta: "Back to My Rings",
  invitePrepareFailed: "Could not prepare invite. Check sign-in and try again.",
  inviteShareFailed: "Could not share or copy the link. Try again.",
  inviteRevokeFailed: "Could not revoke invite.",
  inviteRevoking: "Revoking…",
  inviteRetryCta: "Try again",
  inviteExpiredOrClosed: "This invite expired or was closed. Create a new one.",
  yourRingLabel: "Your ring",
  partnerRingLabel: "Partner's ring",
  howHavenToggleShow: "How your ring works with Face ID",
  howHavenToggleHide: "Hide guide",
  addRing: "Add a ring",
  maxRings: "Up to two rings, one per account.",
  limitReachedHint:
    "This account already has the maximum active rings.",
  ringSince: "Added on",
  boundAt: "Bound at",
  ...
  revokePrepTitle: "Retire this ring?",
  revokePrepBody:
    "This ring will stop working and cannot be transferred.",
  revokePrepContinue: "Continue to verification",
  revokePrepCancel: "Cancel",
  revokeWarning:
    "This ring will stop working.",
  revokeDone: "Ring credential retired successfully.",
  revokeFailed: "Could not retire this ring.",
  ...
  ringsFooterBody:
    "If a ring is lost, retire its credential after Face ID or your device lock. A retired ring is not reassigned to another account.",
  ringsFooterHelpCta: "Open full Help guide",
  privacyNote:
    "One account per person. Sharing is explicit with Plus.",
  iosUsageHint:
    "Touch your ring when you seal. Android can rewrite the ring link in advanced settings.",
