...
const EN = {
  ...
  bindFirstRingCta: "Link Ring",
  linkWithPartnerCta: "Add Partner",
  addPartnerStatus: "Add Partner",
  linkedWithPartnerStatus: "Linked with Partner",
  linkWithPartnerHint: "",
  invitePartnerCta: "Add Partner",
  legacySecondRingTitle: "Add Partner",
  legacySecondRingBody: "",
  legacySecondRingCta: "Add Partner",
  legacyInviteBanner: "",
  pairActiveBanner: "Linked with Partner",
  pairNotCompleteTitle: "",
  pairNotCompleteBody: "",
  pairNotCompleteLocalBody: "",
  syncingRings: "Syncing…",
  refreshingRings: "Syncing…",
  pairShareToggleLabel: "Share sealed memories",
  inviteCreating: "Preparing link…",
  inviteReady: "",
  revokeInvite: "Cancel",
  invitePanelKicker: "",
  invitePanelTitle: "Add Partner",
  invitePanelSubtitle: "Share this link with your partner.",
  inviteBackCta: "Back",
  inviteChecklist: [],
  inviteSelfWarning: "",
  inviteShareCta: "Share Link",
  inviteCopyLinkCta: "Copy Link",
  inviteSharing: "Opening share…",
  inviteLinkCopied: "Link copied.",
  inviteWaitingTitle: "Waiting for partner to join…",
  inviteWaitingBody: "",
  invitePartnerJoinedTitle: "Partner linked.",
  invitePartnerJoinedBody: "",
  inviteDoneCta: "Done",
  ...
  ringsFooterTitle: "Need help?",
  ringsFooterBody: "Lost a ring or pairing issues — see Help.",
