...
const EN = {
  ...
  invitePartnerCta: "Legacy invite",
  legacySecondRingTitle: "Legacy: second ring",
  legacySecondRingBody:
    "Invite another account to link a second ring. Memories stay per account unless you share with Plus.",
  legacySecondRingCta: "Open legacy invite",
  legacyInviteBanner:
    "Recovery path for a second ring. Sharing memories is separate (Plus).",
  ...
  invitePartnerJoinedBody: "Ring linked. Shared memories are explicit in Plus — see Help.",
  ...
  partnerRingLabel: "Legacy pair ring",
