...
const EN = {
  ...
  howHavenWorksKeyPoints: [
    "1. Sign in to read and write — no ring required for daily use.",
    "2. Touch your ring only when you seal; it is not your password or app unlock.",
    "3. Sealed content cannot be edited. View, export, or delete with verification.",
    "4. One account per person. Plus sharing is explicit — never automatic.",
    "5. Memories stay encrypted on your device; Plus adds optional cloud backup.",
  ],
